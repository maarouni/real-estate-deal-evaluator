...
from pdf_generator import generate_pdf , generate_comparison_pdf , generate_comparison_pdf_table_style
load_dotenv()
...
if metrics_a and metrics_b:
    comparison_pdf = generate_comparison_pdf_table_style(metrics_a, metrics_b)
    st.download_button(
